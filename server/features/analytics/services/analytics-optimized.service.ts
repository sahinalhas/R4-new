...
import { getCachedData, setCachedData } from '../repository/cache.repository.js';
import type { ReportsOverview, StudentAnalytics, ClassComparison, EarlyWarning } from './analytics.service.js';

export async function getReportsOverviewOptimized(): Promise<ReportsOverview> {
...
export async function getStudentAnalyticsOptimized(studentId: string): Promise<StudentAnalytics | null> {
